...
$sql = mysqli_query($conn, "select * from product where admin_id='$admin_id'");
    ...
    <table class="styled-table" border=1 align="center">
      ...
      ?>
        ...
        <tr>
          ...
          <td><button class="btn">
              <a style="text-decoration: none;color: white;" href="del1.php?pid=<?php echo $r["pid"]; ?>" onclick="return checkdelete()"> Delete</a></td></button>
          <td><button class="btn1">
              <a style="text-decoration: none;color: white;" href="up1.php?pid=<?php echo $r["pid"]; ?>">Update</a></td></button>
        </tr>
        </tbody>
      <?php
      }
